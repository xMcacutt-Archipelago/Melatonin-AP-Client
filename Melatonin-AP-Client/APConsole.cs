...
namespace Melatonin_AP_Client
{
    public class APConsole : MonoBehaviour
    {
        ...
        private const string FontName = "Inter-Light SDF";
        ...
        private ConsoleAnchorCorner _anchorCorner = ConsoleAnchorCorner.BottomRight;
        ...
        private static void Create()
        {
            ...
            _instance.Log($"by xMcacutt & DawntoldStories");
        ...
        private void Update()
        {
            ...
            if (Keyboard.current.f7Key.wasPressedThisFrame) ToggleConsole();
            if (Keyboard.current.f8Key.wasPressedThisFrame) ToggleHistory();
            ...
            if (_showHistory && _historyScrollRect != null)
            {
                ...
                if (Mathf.Abs(scrollDelta) > 0.01f)
                {
                    ...
                    float newPos = currentPos + (scrollDelta * _historyScrollRect.scrollSensitivity * 0.0001f);
        ...
        private bool AnimateEntry(LogEntry entry, float delta)
        {
            ...
            switch (entry.state)
            {
                ...
                case LogEntry.State.FadeOut:
                    ...
                    var alpha = 1f - t2;
                    if (entry.text != null) entry.text.color = new Color(0.66f, 0.32f, 0.69f, alpha);
                    if (entry.background != null) entry.background.color = new Color(0.99f, 0.99f, 0.99f, alpha);
        ...
        private void AddHistoryEntryVisual(LogEntry entry)
        {
            ...
            text.color = new Color(0.66f, 0.32f, 0.69f, 1);
            bg.color = new Color(0.99f, 0.99f, 0.99f, 1f);
        ...
        private Image GetBackground()
        {
            ...
            imgNew.color = new Color(0.99f, 0.99f, 0.99f, 1f);
        ...
        public void Log(string text)
        {
            ...
            _historyEntries.Add(new LogEntry(text) { colorizedMessage = colorized });
        ...
        private void BuildUI()
        {
            ...
            _historyScrollRect.scrollSensitivity = 1f;
